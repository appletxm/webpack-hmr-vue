...
app.listen(envConfig.dev.port, '127.0.0.1', function(arg){
    console.info('dev server started at: ', 'http://localhost:' + envConfig.dev.port);
    setTimeout(function(){
        var openUrl = 'http://localhost:' + envConfig.dev.port;
        open(openUrl, 'chrome');
    }, 3000);
